...
ret = llm.load_huggingface(
  model=modelpath, model_lora=None, device="cuda", dtype="float32", custom_config=None, load_weight=True
)
...
# TODO: find info on how to choose the best quantization method for the model
